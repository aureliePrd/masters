 ...
 */
 ...
 /* 
 Aurélie Perrard - 25/11/2015
 + Complément script pour ajouter les class mobile, tablette et desktop sur tous les devices.
 y compris tablette samsung galaxy tab - ClassDetectDevices();
 */
	...
	if(w.jQuery) {
		(function($) {
			...
			function CSSSelectorUpdateSize_() {
				...
				to = setTimeout(ClassDetectDevices, 100);
			}
